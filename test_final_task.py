...
def test_process_build_inverted_indexes():
    ...
    assert os.path.exists(PATH_TO_JSON_INDEX), "index file was not created"


def test_process_query_can_process_all_queries_from_file(capsys):
    with open(PATH_TO_SIMPLE_QUERIES, encoding="utf-8") as queries_file:
        process_query(
