...
-- Otherwise you might get an error at some --> as it is written in Notes I didn't write BEGIN and COMMIT
...
-- a) Note how much time it takes to perform this DELETE statement; -->  Query returned successfully in 8 secs 464 msec.
...
--              Execution time | Space Before | Space After | Rollback?
-- DELETE     | 8 secs 464 msec| 575 MB       | 575 MB      | Yes
-- VACUUM FULL| 4 secs 560 msec| 575 MB       | 383 MB      | No
-- TRUNCATE   |  52 msec       | 383 MB       | 0 MB        | Yes 